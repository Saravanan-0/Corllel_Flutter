            ...
            Center(
              child: ClipPath(
                ...
                child: Stack(
                  children: [
                    Image.asset(
                      'assets/images/landimage.png',
                      fit: BoxFit.cover,
                      width: double.infinity,
                      height: double.infinity,
                    ),
                    Positioned(
                      left: _position.dx - MediaQuery.of(context).size.width / 6.4,
                      top: _position.dy - MediaQuery.of(context).size.height / 2.5,
                      child: Stack(
                        children: [
                          SizedBox(
                                ...
                                TextItem(
                                  text: Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      color: const Color.fromARGB(255, 244, 36, 202),
