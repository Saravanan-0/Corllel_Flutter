...
class _MetaWorldScreenState extends State<MetaWorldScreen> {
  ...
  late ScrollController scrollBarVisible;
  ...
  void initState() {
    ...
    scrollBarVisible = ScrollController();
            ...
            Column(
              children: [
                ...
                RawScrollbar(
                  ...
                  thumbColor: const Color.fromARGB(255, 103, 103, 103),
                  shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(20)),
                  trackVisibility: true,
                  trackColor: const Color.fromARGB(255, 180, 180, 180),
                  // trackBorderColor: const Color.fromARGB(96, 255, 0, 0),
                  trackRadius: Radius.circular(20),
                  controller: scrollBarVisible,
                  interactive: true,
